...
export const FALLBACK_TOOL_SECTIONS: AgentToolSection[] = [
  ...
  },
  {
    ...
    label: "Sessions",
    tools: [
      { id: "sessions__list", label: "sessions__list", description: "List sessions" },
      { id: "sessions__history", label: "sessions__history", description: "Session history" },
      { id: "sessions__send", label: "sessions__send", description: "Send to session" },
      { id: "sessions__spawn", label: "sessions__spawn", description: "Spawn sub-agent" },
