...
describe("runEmbeddedAttempt sessions__spawn workspace inheritance", () => {
  it("passes the real workspace to sessions__spawn when workspaceAccess is ro", async () => {
    ...
    const sandbox = createPiToolsSandboxContext({
      ...
      workspaceAccess: "ro",
      tools: { allow: ["sessions__spawn"], deny: [] },
